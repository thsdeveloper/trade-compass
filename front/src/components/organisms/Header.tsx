...
export function Header({ className }: HeaderProps) {
  ...
  return (
    <header
      className={cn(
        'sticky top-0 z-30 hidden h-14 items-center justify-end gap-2 border-b border-border bg-background/95 px-6 backdrop-blur supports-[backdrop-filter]:bg-background/60 lg:flex',
